<h1 align="center">Crowding Risk Monitor</h1>

<p align="center"><a href="README.md">简体中文</a> | <b>English</b></p>

<p align="center">Use Pandadata dragon-tiger and margin data to tell whether a crowded trade has reached a risk-warning level.</p>
...
> This is a QuantSkills Pandadata research and monitoring agent: `agent-crowding-risk-monitor`. It is built for researchers, traders, and AI-agent-assisted market review workflows, turning real market evidence into **readable, reviewable, and reusable** research materials — it places no orders and issues no unconditional buy/sell instructions.

## What It Helps You Answer

> **Has a popular trade become crowded enough to warrant higher risk caution?**

## Workflow

```mermaid
flowchart LR
    q["Research question"] --> data["Pandadata fetch<br/>get_margin · get_lhb_list"]
...
Dragon-tiger heat, margin balance, turnover, and absorption quality.
...
<table>
<tr>
<td width="33%" align="center"><img src="outputs/live/charts/funding_balance_crowding.png" width="100%"><br><sub><b>Main evidence</b><br/>Margin balance vs crowding</sub></td>
<td width="33%" align="center"><img src="outputs/live/charts/lhb_amount_top.png" width="100%"><br><sub><b>Supporting</b><br/>Dragon-tiger amount top</sub></td>
...
| | `crowding_risk_memo.md` | Text memo for research notes. |
| | `crowding_scorecard.json` | Structured scorecard: per-dimension scores and rationale. |
...
| | `de_risk_triggers.md` | De-risk triggers. |
...
| | `counter_evidence.md` | Counter-evidence list: evidence against the main read. |
| | `deliverable_index.md` | Index of all files in this run. |
| | `operator_runbook.md` | How to rerun and how to cross-check. |
| **Data backing** | `data_dictionary.csv` | Tables, fields, and row counts used. |
...
```text
Use agent-crowding-risk-monitor to produce a Pandadata-backed crowding-risk read;
...
- **Upgrade watch**: dragon-tiger heat, margin balance, and turnover keep expanding together.
- **Downgrade watch**: heat spreads but margin does not follow, or high-amount names still show healthy absorption.
