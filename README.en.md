...
This is a QuantSkills Pandadata research and monitoring agent: `agent-crowding-risk-monitor`.
...
- Upgrade watch: 龙虎榜热度、融资余额和成交额继续同步扩张。
- Downgrade watch: 热度扩散但融资不跟随，或高金额样本仍有健康承接。
