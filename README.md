<h1 align="center">拥挤交易风险盯盘 Agent</h1>

<p align="center"><b>简体中文</b> | <a href="README.en.md">English</a></p>

<p align="center">用 Pandadata 龙虎榜与融资数据，判断热门交易是否已经拥挤到需要提高风险警惕。</p>
...
> 这是 QuantSkills 组织的 Pandadata 研究/盯盘 Agent：`agent-crowding-risk-monitor`。它面向研究员、交易者和用 AI Agent 做市场复盘的用户，把真实市场数据整理成**可阅读、可复盘、可交接**的研究材料 —— 不自动下单，也不输出无条件买卖指令。
...
```mermaid
flowchart LR
    q["研究问题"] --> data["Pandadata 取数<br/>get_margin · get_lhb_list"]
...
<table>
<tr>
<td width="33%" align="center"><img src="outputs/live/charts/funding_balance_crowding.png" width="100%"><br><sub><b>主证据</b><br/>融资余额与拥挤度</sub></td>
<td width="33%" align="center"><img src="outputs/live/charts/lhb_amount_top.png" width="100%"><br><sub><b>辅助证据</b><br/>龙虎榜金额 Top</sub></td>
...
| | `crowding_risk_memo.md` | 文字版研判备忘，便于贴进研究日志。 |
| | `crowding_scorecard.json` | 结构化打分卡：各维度评分与判断依据。 |
...
```text
用 agent-crowding-risk-monitor，基于 Pandadata 生成拥挤交易风险研判；
